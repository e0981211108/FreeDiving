USE [FreeDiving]
GO
/****** Object:  Table [dbo].[Evieusers]    Script Date: 2024/11/15 上午 04:00:10 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Members]    Script Date: 2024/11/15 上午 04:00:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[orderdetail]    Script Date: 2024/11/15 上午 04:00:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[orderdetail](
	...
	[custumerName] [nvarchar](100) NULL,
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 2024/11/15 上午 04:00:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Pd]    Script Date: 2024/11/15 上午 04:00:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Evieusers] ([name], [ID], [password], [phone], [address], [email], [manager]) VALUES (N'梁芷郡', N'1', N'1', N'0926189376', N'高雄市小港區大平路126巷29號', N'e20801720@gmail.com', 3)
GO
...
GO
INSERT [dbo].[Evieusers] ([name], [ID], [password], [phone], [address], [email], [manager]) VALUES (N'張言', N'0123456', N'0123456', N'0926189376', N'', N'', 0)
GO
INSERT [dbo].[Evieusers] ([name], [ID], [password], [phone], [address], [email], [manager]) VALUES (N'李彥鋒(VVIP)', N'2', N'2', N'0916666666', N'', N'', 3)
GO
...
GO
INSERT [dbo].[Members] ([ID], [Name], [Account], [Password], [Phone], [Email], [Address], [CreateDate]) VALUES (6, N'e20801724', N'123456', N'0912123459', N'台南市東區勝利路23巷45弄11號', N'ppp000@gmail.com', N'0', CAST(N'2024-11-15T02:51:15.690' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Members] OFF
GO
INSERT [dbo].[orderdetail] ([orderID], [custumerName], [productName], [Quantity], [uninPrice], [totalPrice]) VALUES (1, N'梁芷郡', N'AlchemyV3-30', 1, 19600, 19600)
GO
INSERT [dbo].[orderdetail] ([orderID], [custumerName], [productName], [Quantity], [uninPrice], [totalPrice]) VALUES (2, N'梁芷郡', N'AlchemyV3-30', 1, 19600, 19600)
GO
INSERT [dbo].[orderdetail] ([orderID], [custumerName], [productName], [Quantity], [uninPrice], [totalPrice]) VALUES (3, N'林莉純', N'AlchemyV3-30', 1, 19600, 19600)
GO
INSERT [dbo].[orderdetail] ([orderID], [custumerName], [productName], [Quantity], [uninPrice], [totalPrice]) VALUES (4, N'林莉純', N'AlchemyV3-30', 1, 19600, 19600)
GO
SET IDENTITY_INSERT [dbo].[Orders] ON 
GO
INSERT [dbo].[Orders] ([OrderID], [CustomerName], [ProductName], [Price], [Quantity], [OrderDate], [Status], [CreateDate]) VALUES (1, N'梁芷郡', N'AlchemyV3-30', 19600, 1, CAST(N'2024-11-14T22:26:31.267' AS DateTime), N'待處理', CAST(N'2024-11-14T22:26:31.267' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [CustomerName], [ProductName], [Price], [Quantity], [OrderDate], [Status], [CreateDate]) VALUES (2, N'梁芷郡', N'AlchemyV3-30', 19600, 1, CAST(N'2024-11-14T23:17:10.850' AS DateTime), N'待處理', CAST(N'2024-11-14T23:17:10.850' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [CustomerName], [ProductName], [Price], [Quantity], [OrderDate], [Status], [CreateDate]) VALUES (3, N'林莉純', N'AlchemyV3-30', 19600, 1, CAST(N'2024-11-15T00:08:11.343' AS DateTime), N'待處理', CAST(N'2024-11-15T00:08:11.343' AS DateTime))
GO
INSERT [dbo].[Orders] ([OrderID], [CustomerName], [ProductName], [Price], [Quantity], [OrderDate], [Status], [CreateDate]) VALUES (4, N'林莉純', N'AlchemyV3-30', 19600, 1, CAST(N'2024-11-15T00:27:46.443' AS DateTime), N'待處理', CAST(N'2024-11-15T00:27:46.443' AS DateTime))
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Members__B0C3AC46B7D58987]    Script Date: 2024/11/15 上午 04:00:10 ******/
